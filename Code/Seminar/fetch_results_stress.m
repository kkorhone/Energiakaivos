...
% T_outlet1= mphglobal(model1, 'T_outlet', 'unit', 'degC');
% 
...
% T_outlet2= mphglobal(model2, 'T_outlet', 'unit', 'degC');
% 
...
% T_outlet3= mphglobal(model3, 'T_outlet', 'unit', 'degC');
% 
...
% T_outlet4= mphglobal(model4, 'T_outlet', 'unit', 'degC');
% 
% save('stress.mat',...
...
% hold off
% 
T1 = table(t1,Q_total1,4*Q_above1+4*Q_below1,T_field1,T_outlet1);
T2 = table(t2,Q_total2,4*Q_above2+4*Q_below2,T_field2,T_outlet2);
T3 = table(t3,Q_total3,4*Q_above3+4*Q_below3,T_field3,T_outlet3);
T4 = table(t4,Q_total4,4*Q_above4+4*Q_below4,T_field4,T_outlet4);
