function model = init_quarter_model_with_soil(T_surface, q_geothermal, k_rock, Cp_rock, rho_rock, H_soil, k_soil, Cp_soil, rho_soil)

h_max = min(H_soil/10, 10);
...
model.param.set('H_soil', sprintf('%.3f[m]', H_soil));
model.param.set('k_soil', sprintf('%.3f[W/(m*K)]', k_soil));
model.param.set('Cp_soil', sprintf('%.0f[J/(kg*K)]', Cp_soil));
model.param.set('rho_soil', sprintf('%.0f[kg/m^3]', rho_soil));

model.func.create('piecewise1', 'Piecewise');
model.func('piecewise1').label('Monthly Profile');
model.func('piecewise1').set('funcname', 'monthly_profile');
model.func('piecewise1').set('arg', 't');
model.func('piecewise1').set('extrap', 'periodic');
model.func('piecewise1').set('smooth', 'contd2');
model.func('piecewise1').set('smoothends', true);
model.func('piecewise1').set('pieces', {'0/12' '1/12' '0.175';  '1/12' '2/12' '0.107';  '2/12' '3/12' '0.112'; '3/12' '4/12' '0.083'; '4/12' '5/12' '0.045'; '5/12' '6/12' '0.037'; '6/12' '7/12' '0.032'; '7/12' '8/12' '0.035'; '8/12' '9/12' '0.045'; '9/12' '10/12' '0.087'; '10/12' '11/12' '0.119'; '11/12' '12/12' '0.123'});
model.func('piecewise1').set('argunit', 'a');
model.func('piecewise1').set('fununit', '1');

model.func.create('piecewise2', 'Piecewise');
model.func('piecewise2').set('funcname', 'T_initial');
model.func('piecewise2').set('arg', 'z');
model.func('piecewise2').set('extrap', 'none');
model.func('piecewise2').set('pieces', {'-H_model' '-H_soil' 'T_surface+q_geothermal/k_soil*H_soil-q_geothermal/k_rock*(z+H_soil)'; '-H_soil' '0' 'T_surface-q_geothermal/k_soil*z'});
model.func('piecewise2').set('argunit', 'm');
model.func('piecewise2').set('fununit', 'K');

model.component('model_comp').geom('model_geom').create('blk1', 'Block');
model.component('model_comp').geom('model_geom').feature('blk1').set('pos', {'0' '0' '-H_soil'});
model.component('model_comp').geom('model_geom').feature('blk1').set('size', {'0.5*borehole_spacing' '0.5*borehole_spacing' 'H_soil'});
model.component('model_comp').geom('model_geom').create('blk2', 'Block');
model.component('model_comp').geom('model_geom').feature('blk2').set('pos', {'0' '0' '-L_borehole'});
model.component('model_comp').geom('model_geom').feature('blk2').set('size', {'0.5*borehole_spacing' '0.5*borehole_spacing' 'L_borehole-H_soil'});
...
model.component('model_comp').geom('model_geom').create('blk3', 'Block');
model.component('model_comp').geom('model_geom').feature('blk3').set('pos', {'0' '0' '-H_model'});
model.component('model_comp').geom('model_geom').feature('blk3').set('size', {'0.5*borehole_spacing' '0.5*borehole_spacing' 'H_model-L_borehole'});
...
model.component('model_comp').variable('variables').set('Q_wall', '4*wall_intop(-ht.ndflux)');
...
model.component('model_comp').cpl('wall_aveop').selection.set([4 6 9]);
...
model.component('model_comp').cpl('wall_intop').selection.set([4 6 9]);
...
model.component('model_comp').physics('model_physics').feature('temp_bc').selection.set([11]);
model.component('model_comp').physics('model_physics').create('geo_flux_bc', 'HeatFluxBoundary', 2);
model.component('model_comp').physics('model_physics').feature('geo_flux_bc').selection.set([3 7]);
model.component('model_comp').physics('model_physics').create('wall_flux_bc', 'HeatFluxBoundary', 2);
model.component('model_comp').physics('model_physics').feature('wall_flux_bc').selection.set([4 6 9]);
...
model.component('model_comp').mesh('model_mesh').create('swept_mesh1', 'Sweep');
model.component('model_comp').mesh('model_mesh').create('tetra_mesh', 'FreeTet');
model.component('model_comp').mesh('model_mesh').feature('edge_mesh').selection.set([13]);
model.component('model_comp').mesh('model_mesh').feature('edge_mesh').create('edge_mesh_size', 'Size');
model.component('model_comp').mesh('model_mesh').feature('tri_mesh').selection.set([11]);
...
model.component('model_comp').mesh('model_mesh').feature('swept_mesh').selection.set([3]);
model.component('model_comp').mesh('model_mesh').feature('swept_mesh').create('size1', 'Size');
model.component('model_comp').mesh('model_mesh').feature('swept_mesh1').selection.geom('model_geom', 3);
...
model.component('model_comp').mesh('model_mesh').feature('tetra_mesh').feature('tetra_mesh_size').selection.set([1 2]);
...
model.component('model_comp').mesh('model_mesh').feature('swept_mesh').feature('size1').set('hmax', sprintf('%.3f[m]', h_max));
...
model.component('model_comp').mesh('model_mesh').feature('swept_mesh1').feature('size1').set('custom', 'on');
