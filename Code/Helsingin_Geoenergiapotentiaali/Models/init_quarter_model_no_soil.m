function model = init_quarter_model_no_soil(T_surface, q_geothermal, k_rock, Cp_rock, rho_rock)
...
model.func('piecewise').set('pieces', {'0/12' '1/12' '0.175';  '1/12' '2/12' '0.107';  '2/12' '3/12' '0.112'; '3/12' '4/12' '0.083'; '4/12' '5/12' '0.045'; '5/12' '6/12' '0.037'; '6/12' '7/12' '0.032'; '7/12' '8/12' '0.035'; '8/12' '9/12' '0.045'; '9/12' '10/12' '0.087'; '10/12' '11/12' '0.119'; '11/12' '12/12' '0.123'});
...
model.component('model_comp').geom('model_geom').feature('blk1').set('pos', {'0' '0' '-L_borehole'});
model.component('model_comp').geom('model_geom').feature('blk1').set('size', {'0.5*borehole_spacing' '0.5*borehole_spacing' 'L_borehole'});
...
model.component('model_comp').geom('model_geom').feature('blk2').set('pos', {'0' '0' '-H_model'});
model.component('model_comp').geom('model_geom').feature('blk2').set('size', {'0.5*borehole_spacing' '0.5*borehole_spacing' 'H_model-L_borehole'});
...
model.component('model_comp').cpl('wall_intop').selection.set([4 6]);
