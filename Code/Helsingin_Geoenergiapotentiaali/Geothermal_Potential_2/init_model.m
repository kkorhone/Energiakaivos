function model = init_model(borehole_length, borehole_spacing)
...
swept_mesh_distr.set('numelem', sprintf('%.0f', borehole_length/10)); % <--- number of sweeps
