...
% quarter_hectare.m
%
% Model exported on Jun 18 2018, 15:11 by COMSOL 5.3.0.223.
...
model.label('quarter_hectare.mph');

model.comments(['Quarter hectare\n\n']);
...
model.func('piecewise').set('pieces', {'0/12' '1/12' '1.000';  ...
'1/12' '2/12' '1.000';  ...
'2/12' '3/12' '1.000';  ...
'3/12' '4/12' '1.000';  ...
'4/12' '5/12' '1.000';  ...
...
model.component('model_comp').mesh('model_mesh').feature('edge_mesh').feature('edge_mesh_size').set('hmax', '1[mm]');
...
model.component('model_comp').mesh('model_mesh').feature('tri_mesh').feature('tri_mesh_size').set('hmax', '1[m]');
...
model.component('model_comp').mesh('model_mesh').feature('tri_mesh').feature('tri_mesh_size').set('hgrad', 1.1);
...
model.component('model_comp').mesh('model_mesh').feature('swept_mesh').feature('swept_mesh_distr').set('numelem', 50);
...
model.component('model_comp').mesh('model_mesh').feature('tetra_mesh').feature('tetra_mesh_size').set('hgrad', 1.1);
