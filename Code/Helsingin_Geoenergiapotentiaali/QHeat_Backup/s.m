...
% s.m
%
% Model exported on Jun 25 2019, 09:45 by COMSOL 5.4.0.295.
...
model.component('model_component').mesh('model_mesh').create('bl1', 'BndLayer');
...
model.component('model_component').mesh('model_mesh').feature('bl1').selection.geom('model_geometry', 3);
model.component('model_component').mesh('model_mesh').feature('bl1').selection.set([2 3]);
model.component('model_component').mesh('model_mesh').feature('bl1').create('blp', 'BndLayerProp');
model.component('model_component').mesh('model_mesh').feature('bl1').feature('blp').selection.set([11]);
...
model.component('model_component').mesh('model_mesh').feature('bl1').feature('blp').set('blnlayers', 3);
