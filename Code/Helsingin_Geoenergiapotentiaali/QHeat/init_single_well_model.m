function model = init_single_well_model()
...
bedrock_rectangle.set('pos', {'-W_model' '0'});
bedrock_rectangle.set('size', {'W_model' 'W_model'});
...
bottom_bedrock_block.set('pos', {'-W_model' '0' '-H_model'});
bottom_bedrock_block.set('size', {'W_model' 'W_model' 'H_model-L_borehole'});
