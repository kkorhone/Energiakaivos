...
for i = 1:length(rock_type)
    ...
    [E_single, E_field] = eval_energies(T_surface, q_geothermal, k_rock(i), Cp_rock(i), rho_rock(i), 300.0, borehole_spacing, 50.0);
    
    file_name = sprintf('comsol_results_300_%d.txt', i);
