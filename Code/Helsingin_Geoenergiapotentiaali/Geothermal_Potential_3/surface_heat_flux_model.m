function out = model
%
% surface_heat_flux_model.m
%
% Model exported on Apr 4 2019, 16:08 by COMSOL 5.4.0.295.
...
model.label('surface_heat_flux_model.mph');
...
model.component('model_comp').view('view1').axis.set('xmin', -19.14629364013672);
model.component('model_comp').view('view1').axis.set('xmax', 90.34033203125);
model.component('model_comp').view('view1').axis.set('ymin', -36.251953125);
model.component('model_comp').view('view1').axis.set('ymax', 10.866209030151367);
...
model.component('model_comp').mesh('model_mesh').feature('ftri1').feature('size1').set('custom', 'on');
model.component('model_comp').mesh('model_mesh').feature('ftri1').feature('size1').set('hmax', 1);
model.component('model_comp').mesh('model_mesh').feature('ftri1').feature('size1').set('hmaxactive', true);
...
model.result('pg2').create('str3', 'Streamline');
model.result('pg2').create('str1', 'Streamline');
model.result('pg2').create('str2', 'Streamline');
model.result('pg2').feature('str3').selection.set([7 9]);
model.result('pg2').feature('str1').selection.set([7 9]);
model.result('pg2').feature('str2').selection.set([7 9]);
...
model.result('pg2').feature('arws1').set('xcoord', '0.07 range(1,0.1,1000)');
model.result('pg2').feature('arws1').set('arrowymethod', 'coord');
model.result('pg2').feature('arws1').set('ycoord', 0);
model.result('pg2').feature('arws1').set('arrowlength', 'normalized');
model.result('pg2').feature('arws1').set('scale', 0.01);
model.result('pg2').feature('arws1').set('scaleactive', true);
model.result('pg2').feature('str3').label('Streamline 0');
model.result('pg2').feature('str3').set('posmethod', 'start');
model.result('pg2').feature('str3').set('startmethod', 'coord');
model.result('pg2').feature('str3').set('xcoord', 'range(0,0.1,200)');
model.result('pg2').feature('str3').set('ycoord', -150);
model.result('pg2').feature('str3').set('color', 'green');
...
model.result('pg2').feature('str1').set('xcoord', 'range(0.1,0.1,35.4)');
model.result('pg2').feature('str1').set('ycoord', 0);
model.result('pg2').feature('str1').set('color', 'red');
model.result('pg2').feature('str1').set('resolution', 'normal');
model.result('pg2').feature('str2').set('posmethod', 'start');
model.result('pg2').feature('str2').set('startmethod', 'coord');
model.result('pg2').feature('str2').set('xcoord', 'range(35.5,0.1,200)');
model.result('pg2').feature('str2').set('ycoord', 0);
model.result('pg2').feature('str2').set('color', 'blue');
model.result('pg2').feature('str2').set('resolution', 'normal');
model.result('pg3').label('Surface Heat Flux Plot');
model.result('pg3').set('looplevel', {'interp'});
model.result('pg3').setIndex('interp', '456', 0);
model.result('pg3').feature('arws1').label('Surface Heat Flux Arrows');
model.result('pg3').feature('arws1').set('arrowxmethod', 'coord');
model.result('pg3').feature('arws1').set('xcoord', 'range(0,0.1,r_model)');
model.result('pg3').feature('arws1').set('arrowymethod', 'coord');
model.result('pg3').feature('arws1').set('ycoord', 0);
model.result('pg3').feature('arws1').set('scale', 0.6691718471643201);
model.result('pg3').feature('arws1').set('scaleactive', false);
model.result.export('plot1').set('plotgroup', 'pg3');
model.result.export('plot1').set('plot', 'arws1');
model.result.export('plot1').set('filename', 'E:\Work\Helsingin_Geoenergiapotentiaali\Geothermal_Potential_3\surface_heat_flux.txt');
