...
#data = numpy.vstack((train_data[:,3:], test_data[:,3:]))
...
E_pred = results.predict(sm.add_constant(X))

#pylab.plot(E_borehole, "b.")
#pylab.plot(E_pred, "r.")
pylab.plot(E_borehole-E_pred, "r.")
pylab.show()

csv_file = open("dataset_150.csv", "w")
