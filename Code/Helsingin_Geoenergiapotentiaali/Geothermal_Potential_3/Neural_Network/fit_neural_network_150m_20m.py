...
pylab.savefig("histograms_150m_20m_gk25.png")
#pylab.show()
...
pylab.savefig("learning_history_150m_20m_gk25.png")
#pylab.show()
...
csv_file = open("geothermal_potential_map_150m_20m_gk25.csv", "w")
...
pylab.savefig("potential_maps_150m_20m_gk25.png")
pylab.show()
