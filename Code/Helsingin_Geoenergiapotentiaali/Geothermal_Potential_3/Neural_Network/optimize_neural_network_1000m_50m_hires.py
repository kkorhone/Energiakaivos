...
train_data = numpy.loadtxt("train_1000m_50m_min.txt")
test_data = numpy.loadtxt("test_1000m_50m_min.txt")

train_data = numpy.vstack((train_data[:,3:], test_data[:,3:]))
...
csv_file = open("results_hires_1000m_50m.csv", "w")
...
for variant in variants:
    ...
    pylab.savefig("learning_history_1000m_50m_%02d.png" % counter)
    ...
    csv_file = open("results_hires_1000m_50m.csv", "a")
    if len(variant) == 2:
