...
train_data = numpy.loadtxt("train_1000m_20m_min.txt")
test_data = numpy.loadtxt("test_1000m_20m_min.txt")
poly_data = numpy.loadtxt("field_polies_1000m_20m_min.txt")
...
pylab.savefig("histograms_1000m_20m_gk25.png")
#pylab.show()
...
pylab.savefig("learning_history_1000m_20m_gk25.png")
#pylab.show()
...
csv_file = open("geothermal_potential_map_1000m_20m_gk25.csv", "w")
...
pylab.savefig("potential_maps_1000m_20m_gk25.png")
pylab.show()
