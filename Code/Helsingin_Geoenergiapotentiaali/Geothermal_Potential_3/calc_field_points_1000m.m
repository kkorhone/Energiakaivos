...
%file_id = fopen('train_1000m_20m_min.txt', 'w');
file_id = fopen('train_1000m_50m_min.txt', 'w');
...
for i = train_indexes
    ...
    %[E, func_value, exit_flag] = fminbnd(obj_func, 27, 36, options);
    [E, func_value, exit_flag] = fminbnd(obj_func, 83, 93, options);
...
%file_id = fopen('test_1000m_20m_min.txt', 'w');
file_id = fopen('test_1000m_50m_min.txt', 'w');
