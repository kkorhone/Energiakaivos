function model = init_300m_model(borehole_spacing, cooling_fraction, tlist)
...
model.param.set('annual_heating_demand', '10.888[MW*h]');
...
swept_mesh_distr.set('elemratio', 30);
