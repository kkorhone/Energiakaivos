...
# $Id$
# ===========================================================================
# Python module for transforming between projected coordinates and
# geographical coordinates.
# ===========================================================================

__all__ = [ "ReferenceEllipsoid", "TransverseMercatorProjection",
            "GRS80_ELLIPSOID", "INT24_ELLIPSOID", "TM35_PROJECTION",
            "KKJ0_PROJECTION", "KKJ1_PROJECTION", "KKJ2_PROJECTION",
            "KKJ3_PROJECTION", "KKJ4_PROJECTION", "KKJ5_PROJECTION" ]
...
def _convert_projected_to_geodetic(E, N, a, f, lam0, E0, k0):
    ...
    if i == _MAXIMUM_ITERATIONS:
        raise RuntimeException, "No convergence after %d iterations." % _MAXIMUM_ITERATIONS
