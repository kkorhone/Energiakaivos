...
data_frame = pandas.read_excel("sampled_map_points_gk25.xlsx")
...
data_frame.insert(loc=7, column="MaxPot150", value=maximum_potential[:,0])
data_frame.insert(loc=8, column="MaxPot300", value=maximum_potential[:,1])
data_frame.insert(loc=9, column="MaxPot1000", value=maximum_potential[:,2])

excel_writer = pandas.ExcelWriter("maximum_potentials_gk25.xlsx")
